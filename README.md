...
- train on Cityscapes dataset (train), [model](https://drive.google.com/open?id=1ZKGBQogSqxyKD-QIJgzyDXw2TR0HUePA) with 69.57 mIoU
```
python train.py --dataset cityscapes
```
- train on CamVid dataset (trainval), [model](https://drive.google.com/open?id=1OuiYh1VDPVc2jkT_UDJ9rE4meAutc4bv)  with 66.53 mIoU
```
